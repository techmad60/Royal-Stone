...
export default function Main () {
    return (
        <main className="">
            ...
            <section className="flex flex-col justify-start items-start bg-white pt-12 px-4 sm:justify-center sm:items-center lg:px-0 xl:justify-center xl:items-center xl:flex-row xl:gap-12">
                <div className="flex flex-col justify-center">
                    <div className="flex flex-col justify-start items-start">
                        <h2 className={`text-color-zero text-[22px] font-extrabold whitespace-nowrap lg:text-[28px]`}>Our Services</h2>
                        <p className="text-sm text-[rgba(15,28,57,0.8)] leading-[30px] w-[345px] my-2 text-start sm:w-[400px] lg:text-[16px] lg:w-[600px] xl:w-[482px] ">Proin quam varius facilisis urna. Viverra at vitae lacus at ut volutpat. Amet commodo venenatis in congue. Sit eget nullam nunc neque nulla venenatis. Felis ornare nulla eros dolor viverra quis odio or</p>
                    </div>
                    <Image 
                        src={"/images/dashboard.svg"}
                        alt="App Dashboard"
                        className="mt-20 sm:w-[350px] lg:w-[450px] xl:w-[592.87px] self-center"
                        width={345}
                        height={430}
                    />
                </div>

                <div className="flex flex-col space-y-6 justify-center items-center mt-12 xl:mt-0 xl:border-l xl:pl-20">
                    {/* Make an Investment */}
                    <section className="flex flex-col justify-start items-start border border-slate-100 bg-color-three p-4 rounded-[25px] w-[345px] h-[275px] sm:w-[370px]  lg:w-[450px]">
                        <Image 
                        ...
                        <div className="flex flex-col justify-start items-start">
                            ...
                            <p className="text-sm leading-[30px] text-[rgba(15,28,57,0.8)]">Proin quam varius facilisis urna. Viverra at vitae lacus at ut volutpat. Amet commodo venenatis in congue. Sit eget nullam nunc neque nulla venenatis. Felis ornare nulla eros dolor viverra quis odio or</p>
                        </div>
                    </section>
