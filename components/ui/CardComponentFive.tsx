...
export default function CardComponentFive({icon, label, number, classname, width, textSize}: NavLinkProps) {
    return (
        <section className={`flex flex-col bg-color-two text-color-one space-y-1 rounded-common p-3 shadow-sm justify-center w-[168px] h-[110px] sm:p-4 sm:space-y-3 lg:h-[139px] ${width}`}>
