...
export default function DownloadApp() {
    return (
        <div className="flex flex-col justify-center w-full h-[191px] items-center bg-color-one text-center rounded-[20px] mx-4 bg-lim lg:h-[275px] lg:max-w-4xl xl:max-w-[76rem]">
