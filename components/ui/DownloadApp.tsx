...
export default function DownloadApp() {
    return (
        <div className="flex flex-col justify-center items-center bg-green-700 text-center w-[350px] h-[350px] p-4 rounded-lg sm:w-[450px] sm:p-6 md:w-[550px] md:p-8 lg:w-[900px] lg:p-10 xl:w-[1050px] xl:p-12">
