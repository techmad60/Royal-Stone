...
export default function CardComponent ({icon = "", title, text}:CardComponentProps) {
    return (
        <section className="flex flex-col justify-start items-start border border-slate-100 w-[320px] bg-color-three p-4 rounded-common xs:w-[345px] h-[380px] sm:w-[370px] xl:w-[450px]">
