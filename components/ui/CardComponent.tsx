...
export default function CardComponent ({title = "", text = "", icon = ""}) {
    return (
        <section className="flex flex-col justify-start items-start border border-slate-100 w-[320px] bg-color-three p-4 rounded-[25px] xs:w-[345px] h-[275px] sm:w-[370px] xl:w-[450px]">
