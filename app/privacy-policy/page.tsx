        ...
        <div className={`${montsy.className} flex flex-col`}>
            ...
            <main>
                <section className="flex flex-col justify-center items-center pt-16">
                    <h1 className={`text-color-zero font-semibold text-xl my-4 text-center lg:text-4xl  ${poppins.className}`}>
                        Privacy Policy
                    </h1>
                    <p className="text-sm text-color-zero lg:text-xl">
                    Updated Last: 30th September 2024
                    </p>
                </section>
                <section className="flex flex-col justify-center items-center max-w-5xl mx-auto">
                    <p className="px-12 text-xs text-color-zero font-extralight lg:text-sm pt-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <p className="px-12 text-xs text-color-zero font-light lg:text-sm pt-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <p className="px-12 text-xs text-color-zero font-light lg:text-sm pt-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
