    ...
    return (
        <div className="lg:grid grid-cols-2 gap-8">
            <section className="bg-color-two hidden px-8 lg:flex flex-col space-y-8">
                ...
                <p className="font-extrabold text-[29px] text-color-one lg:w-[561px]">1,000+ users are making smart investment choices. Why not be one of them? 🤔</p>
                <Image 
            ...
            <section className="flex flex-col p-4 space-y-6 lg:px-8">
                ...
                <section className="flex flex-col space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {/* Signup with Email */}
                        <CardComponentFour icon="/images/mail-icon.svg" text="Email" className="lg:h-[83px]"/>

                        {/* Signup with Google */}
                        <CardComponentFour icon="/images/google-icon.svg" text="Google" className="lg:h-[83px]"/>

                        {/* Signup with Apple (full width across both columns) */}
                        <CardComponentFour icon="/images/apple-icon.svg" text="Apple" className="col-span-2 justify-between h-[83px]" />
                    </div>
                </section>
