  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex items-center justify-between max-w-[535px]">
        <h1 className="text-colour-five text-base mt-8 lg:text-[18px]">Complete Setup</h1>
        <Link href="/dashboard" className="flex items-center justify-center text-sm text-white text-center mt-8 bg-color-one rounded-xl hover:bg-green-700 w-[71px] h-[26px]">   
          Skip
        </Link>
      </div>
