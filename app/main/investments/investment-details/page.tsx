    ...
    return (
        <div>
            ...
            <div className="overflow-x-scroll flex gap-2 my-4">
                <Image src="/images/potato-2.svg" width={110} height={111} alt="potatoes"/>
                <Image src="/images/potato-2.svg" width={110} height={111} alt="potatoes"/>
                <Image src="/images/potato-2.svg" width={110} height={111} alt="potatoes"/>
                <Image src="/images/potato-2.svg" width={110} height={111} alt="potatoes"/>
                <Image src="/images/potato-2.svg" width={110} height={111} alt="potatoes"/>
            ...
            <section className="flex gap-4 items-center justify-between bg-light-grey p-4 rounded-[10px] shadow-sm">
            ...
            <hr className="my-4"/>
            <section className="flex gap-12 bg-light-grey shadow-sm rounded-[10px] p-6 ">
            ...
            <section className="p-6 bg-light-grey shadow-sm mt-4 space-y-4">
