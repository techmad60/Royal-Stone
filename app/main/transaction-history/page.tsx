        ...
        <div className="">
            ...
            <div className="hidden lg:grid">
                ...
                <section  className="grid grid-cols-8 px-3 mr-8 border-b py-4 my-4">
                    ...
                    <p className="text-sm text-color-zero col-span-2">Sept 9, 2024  |  9:12 AM</p>
                ...
                <section  className="grid grid-cols-8 px-3 mr-8 border-b py-4 my-4">
                    <div className="flex items-center gap-3 col-span-2">
                        ...
                        <p className="text-sm text-color-zero">Investment Fund Withdrawal</p>
                    </div>
                    <p className="text-sm text-color-zero">$20</p>
                    <p className="text-sm text-color-zero col-span-2">Sept 9, 2024  |  9:12 AM</p>
                ...
                <section  className="grid grid-cols-8 px-3 mr-8 border-b py-4 my-4">
                    ...
                    <p className="text-sm text-color-zero">$20</p>
                    <p className="text-sm text-color-zero col-span-2">Sept 9, 2024  |  9:12 AM</p>
                    <p className="text-sm text-color-one col-span-2">Savings Payment - Successful</p>
                    <Link href="" className="flex items-center justify-center border rounded-[20px] gap-2 w-[78px] h-[22px]">
                        <p className="text-xs text-color-form">View</p>
                        <IoIosArrowForward className="text-color-form text-sm" />
                    </Link>
                ...
                <section  className="grid grid-cols-8 px-3 mr-8 border-b py-4 my-4">
                    ...
                    <p className="text-sm text-color-zero">$20</p>
                    <p className="text-sm text-color-zero col-span-2">Sept 9, 2024  |  9:12 AM</p>
                    <p className="text-sm text-red-500 col-span-2">Savings Payment - Successful</p>
                    <Link href="" className="flex items-center justify-center border rounded-[20px] gap-2 w-[78px] h-[22px]">
                        <p className="text-xs text-color-form">View</p>
                        <IoIosArrowForward className="text-color-form text-sm" />
                    </Link>
