  ...
  return (
    <div className="flex flex-col space-y-4 lg:pr-8">
      ...
      <div className="flex gap-4 pb-3">
        <CardComponentFive icon={<TbTargetArrow className="text-2xl"/>} label="Total Savings Target" number={0}/>
        <CardComponentFive icon={<BsFileBarGraphFill className="text-2xl"/>} label="Total Investments Made" number={0}/>
      </div>
